...
struct FilterValidator {
    ...
    struct Input {
        ...
        let level: KQTSwiftyBeaver.Level
        let path: String
        let function: String
        let message: String?
    }
    ...
    private static func filterMatchesCondition(_ filter: FilterType, level: KQTSwiftyBeaver.Level,
    ...
    private static func filterMatchesMinLogLevel(_ filter: FilterType, level: KQTSwiftyBeaver.Level) -> Bool {
