...
open class BaseDestination: Hashable, Equatable {
    ...
    open var minLevel = KQTSwiftyBeaver.Level.verbose
    ...
    open func send(_ level: KQTSwiftyBeaver.Level, msg: String, thread: String, file: String,
    ...
    func formatMessage(_ format: String, level: KQTSwiftyBeaver.Level, msg: String, thread: String,
    ...
    func messageToJSON(_ level: KQTSwiftyBeaver.Level, msg: String,
    ...
    func levelWord(_ level: KQTSwiftyBeaver.Level) -> String {
    ...
    func colorForLevel(_ level: KQTSwiftyBeaver.Level) -> String {
        var color = ""
    ...
    func shouldLevelBeLogged(_ level: KQTSwiftyBeaver.Level, path: String,
