...
public protocol FilterType : AnyObject {
    ...
    func reachedMinLevel(_ level: KQTSwiftyBeaver.Level) -> Bool
}
...
public class Filter {
    ...
    let required: Bool
    let minLevel: KQTSwiftyBeaver.Level

    public init(_ target: Filter.TargetType, required: Bool, minLevel: KQTSwiftyBeaver.Level) {
    ...
    public func reachedMinLevel(_ level: KQTSwiftyBeaver.Level) -> Bool {
...
public class CompareFilter: Filter, FilterType {
    ...
    override public init(_ target: Filter.TargetType, required: Bool, minLevel: KQTSwiftyBeaver.Level) {
...
public class FunctionFilterFactory {
    public static func startsWith(_ prefixes: String..., caseSensitive: Bool = false,
                                  required: Bool = false, minLevel: KQTSwiftyBeaver.Level = .verbose) -> FilterType {
    ...
    public static func custom(required: Bool = false, minLevel: KQTSwiftyBeaver.Level = .verbose, filterPredicate: @escaping (String) -> Bool) -> FilterType {
